      ...
      <div className="bg-white rounded-lg max-w-md w-full overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          <div className="text-center mb-6">
            ...
            <h3 className="text-lg font-medium text-gray-900">Access Admin Panel</h3>
          ...
          <button
            ...
            className="w-full bg-rose-600 text-white py-3 px-4 rounded-lg hover:bg-rose-700 transition-colors font-medium disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
          >
            {isLoading ? (
              <>
          ...
          <div className="text-center">
            <p className="text-xs text-gray-500">
              For demo purposes: Use the provided admin credentials
            </p>
          </div>
        </form>
      </div>
